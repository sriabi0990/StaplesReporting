...
app.controller('ReportFields', function($scope, $http) {
    ...
    $scope.submit = function() {
        ...
        $http({
            method: 'POST',
            url: "http://localhost:8099/generateReport/SEAUK/?productcolumns=" + $scope.data.productAttri + "&packagecolumns=" + $scope.data.packagingAttri,
        ...
        var newEle = angular.element("<div class='files' id='downloadlink'><a href='http://localhost:8099/download/SEAUK'>Download File</a> </div>");
